...
public class DateLastVisitTest {
    ...
    public void it_evaluates_data(@Mocked Evaluation mockEvaluation,
        ...
        EvaluationColumn column = new DateLastVisit(mockEvaluation, options());

        CaseData result = column.evaluate(mockRawData, testCase());

        assertThat(result.string("date_last_visit")).isEqualTo("foobar");
    }
}