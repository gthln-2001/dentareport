...
public class KaplanMeierTest {
    ...
    private Db db;
    private KaplanMeier kaplanMeier;
    @Mocked
    ...
    public void setUp() throws Exception {
        ...
        new Expectations() {{
            ...
            new AvailableDependencies("evaluation_type").dependencies();
            ...
            new AvailableEvents("evaluation_type").events();
            result = ImmutableList.of(
                    mockEvent1,
                    mockEvent2
            );
        ...
        kaplanMeier = new KaplanMeier(mockEvaluation);
    }
    ...
    @Test
    public void it_rebuilds_table_for_kaplan_meier_data() {
        kaplanMeier.evaluate();

        assertThat(db.hasTable("some_table" + Keys.DB_TABLE_SUFFIX_KAPLAN_MEIER)).isTrue();
    }

    @Test
    public void it_calls_kaplan_meier_calculator_for_each_possible_item_combinations() {
        kaplanMeier.evaluate();
