...
//                    "view", Keys.GUI_VIEW_EVALUATION_TELESCOPIC_CROWN_PROBABILITIES_DISPLAY,
...
//    }
    ...
    @Override
    protected Pane pane() {
        return new EvaluationTelescopicCrownProbabilities(mockGui,
                                                          ImmutableMap.of("evaluationId",
                                                                          Keys.EVALUATION_TYPE_TELESCOPIC_CROWN)).pane();
    }
