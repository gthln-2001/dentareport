...
public class EvaluationTelescopicCrownTest extends BaseFxElementTest {

    @Mocked
    Gui mockGui;
    private EvaluationTelescopicCrown evaluationTelescopicCrown;
...
//        new Expectations() {{
//            Metadata.has(Keys.METADATA_KEY_VALID_EVALUATION_TELESCOPIC_CROWN);
//            result = true;
//        }};
//
...
//                                                   Keys.GUI_VIEW_EVALUATION_TELESCOPIC_CROWN_GENERAL,
//                                                   "evaluationId",
//                                                   "9"));
//            times = 1;
//        }};
...
//                   .text(Keys.GUI_TEXT_ERROR_NO_VALID_EVALUATION_TELESCOPIC_CROWN)
//                   .create();
//            mockGui.setContentPane(Keys.GUI_VIEW_EVALUATION_TELESCOPIC_CROWN_GENERAL);
//            times = 0;
//        }};
//    }
//
...
//
//        new Verifications() {{
//            mockGui.setContentPane(ImmutableMap.of("view", Keys.GUI_VIEW_EVALUATION_TELESCOPIC_CROWN_PROBABILITIES,
//                                                   "evaluationId", Keys.EVALUATION_TYPE_TELESCOPIC_CROWN));
//            times = 1;
//        }};
//    }
//
...
//                   .create();
//            times = 1;
//            mockGui.setContentPane(Keys.GUI_VIEW_EVALUATION_TELESCOPIC_CROWN_PROBABILITIES);
//            times = 0;
//        }};
//    }
//
...
//
//        new Verifications() {{
//            new Thread(new EvaluatorTask(Keys.METADATA_KEY_VALID_EVALUATION_TELESCOPIC_CROWN, Evaluation9.class));
//            mockThread.start();
//            times = 1;
//        }};
//    }
...
//
//        clickOn(Keys.GUI_TEXT_START_NEW_EVALUATION);
//        evaluationTelescopicCrown.finished();
//
//        List<String> provider = ImmutableList.of(
//                "#button-back",
//                "#button-quit",
...
//    }
    ...
    @Override
    protected Pane pane() {
        evaluationTelescopicCrown = new EvaluationTelescopicCrown(mockGui, ImmutableMap.of());
        return evaluationTelescopicCrown.pane();
    }
