...
public class EvaluationFillingProbabilitiesDisplayTest extends BaseFxElementTest {
...
//    }
    ...
    @Override
    protected Pane pane() {
        return new EvaluationFillingProbabilitiesDisplay(mockGui, testOptions()).pane();
    }
